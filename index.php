...
<!-- end -->
        ...
        <div class="container-fluid" style="padding: 50px; margin: 20px 0; ">
              <h1 style="color: #00f!important; text-align: center !important;" >Recent Post</h1>
              <p style="color: #00f !important; text-align: center !important;">Recent Reviews From Real User</p>
        <div class="row">
          <?php
$sqlQuery = "SELECT * FROM travelpost ORDER BY PostID DESC LIMIT 4";
            ...
            if (isset($_SESSION['user']))
            {
                ...
                else
                {
                    echo "
                        ...
                        <button name='AddFav' class='btn btn-primary' style='float: right !important; '>Add to favourite</button></form>";
...
?>
    <div class="py-2 text-center">
            <?php include("./horizontal_ad.php");?>
    </div>
      <!-- Most Reviewed -->
      <div class="container-fluid bg-light" style="padding: 50px;margin: 50px 0; ">
              <h1 style="color: #00f !important; text-align: center !important ; ">Most Reviewed</h1>
              <p style="color: #00f !important; text-align: center !important;">Some of the popular content</p>
            ...
            while ($ListMainPosts = mysqli_fetch_assoc($GetImgMainRows))
            {
                echo "<div class='col-md-4  my-4'>
                  <div class='card shadow'>
                      ...
                      <div class='card-body'>
                        <h5 class='card-title' style='font-size:2em;'>" . $ListPost["Title"] . "</h5>
                        <p class='card-text'>
                          " . substr($ListPost["Message"], 0, 100) . "
                        </p>
                        <a href='./single.php?IDNumber=" . $postIDS . "'class='btn btn-primary' '>Read More</a>
...
<div class="col-md-4">
    <?php include('./vertical_ad.php') ?>
      ...
      <!-- You may also like -->
      <div class="container-fluid" style="padding: 50px; margin: 50px 0;">
              <h1 style="color: #00f !important; text-align: center !important;;">You may also like.</h1>
              <p style="color: #00f !important; text-align: center !important;">We know what you like :)</p>
        <div class="row">
            <div class="col-md-8">
                <div class="row">
          <?php
