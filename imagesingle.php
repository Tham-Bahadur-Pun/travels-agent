...
<img src="./travel-images/large/<?php echo $ListPost['Path']; ?>" class="img-fluid" alt="..." style="max-height: 500px;" />
...
<h3 style="padding: 10px; font-size:2em;">More Info</h3>
<div class="container">
  <div class="row">
    <div class="col">
  ...
  <tbody>
    ...
    <div class="col">
      <div id="my_map_add" style="width:100%;height:350px;"></div>
...
<div class="card text-white mb-3 mx-auto" style="width:70%;">
  <div class="card-header bg-primary" style="font-size:2em;">Write a review.</div>
...
{
    echo "<div class='alert alert-info' role='alert' style='font-size:2em;'>
...
?>
    ...
    <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
                    <h5 class="mb-1" style="font-size:2em;">All Ratings and Reviews</h5><br>
                    <?php
                        ...
                        <div class='media'>
                            <div class='media-body'>
                                <div class='reviews-members-header'>
                                    <h6 class='mb-1'><a class='text-black' href='#' style='font-size:2em;'>" . $Fname . " " . $Lname . "</a></h6>
