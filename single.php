...
<div class="container-fluid px-5 py-2" style="margin-top: 20px; margin-bottom: 20px;">
<h2 style="padding: 10px; text-transform: uppercase; font-family:Verdana, Geneva, Tahoma, sans-serif; font-weight:700;"><?php echo $PageTitle; ?></h2>
<img src="./travel-images/large/<?php echo $ListMainPosts['Path']; ?>" class="img-fluid w-100 post-image" alt="...">
...
<div style="padding: 20px; text-align: justify; " class="fs-3"><?php echo $PostMessage; ?></div>
</div>
</div>

<div class="card text-white mb-3 mx-auto" style="width:70%;">
  <div class="card-header bg-info fs-3" >Write a review</div>
...
{
    echo "<div class='alert alert-info fs-3' role='alert'>
...
?>
      ...
      <span class="heading fs-3">User Rating</span>
      <div class='rate'>
        <?php
...
?>
    ...
    <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
                    <h5 class="mb-1 fs-3">All Ratings and Reviews</h5><br>
                    <?php
                        ...
                        <div class='media'>
                            <div class='media-body'>
                                <div class='reviews-members-header'>
                                    <h6 class='mb-1' style='font-size:1.5em'><a class='text-black' href='#'>" . $Fname . " " . $Lname . "</a></h6>
                                    <p class='text-gray' style='font-size: 13px; color: gray;'> Posted On: " . $ReviewsDate . "</p>
                                </div>
                                <div class='reviews-members-body' style='font-size:1.5em'>
                                    <p style='font-family:Oswald;'> " . $Reviews . " </p>
                                </div>
                            </div>
                        </div><hr>";
        }
...
<div class="container-fluid bg-info" style="padding: 50px; margin-bottom: 20px;">
            ...
            echo "<div class='col-md' >
                <div class='card'>
                    <div class='bg-image hover-overlay ripple' data-mdb-ripple-color='light'>
                      <img
                        src='./travel-images/large/" . $ListMainPosts['Path'] . "' 
                        class='img-fluid'
                      />
                      <a href='#!'>
                    ...
                    <div class='card-body'>
                      ...
                      <a href='./single.php?IDNumber=" . $postIDS . "'class='btn btn-primary' style='font-size:1em'>Read More</a>
                    </div>
                  </div>
              </div>";
        }
